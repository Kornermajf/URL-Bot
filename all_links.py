...
random_nanolinks = f'https://computerpedia.in/includes/open.php?id={choice(list(range(900760, 900859 + 1)))}'

random_teraboxlinks = f'https://financialstudy.me/includes/open.php?id={choice(list(range(305335, 305434 + 1)))}'
